...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "jamesMont.Android.dll" comes first in this list. */
		"jamesMont.Android.dll",
		"FormsViewGroup.dll",
		"Microsoft.Azure.Mobile.Client.dll",
		"Microsoft.Azure.Mobile.Client.SQLiteStore.dll",
		"MvvmHelpers.Android.dll",
		"MvvmHelpers.Bootstrap.dll",
		"MvvmHelpers.Core.dll",
		"MvvmHelpers.dll",
		"Newtonsoft.Json.dll",
		"PCLCrypto.dll",
		"PInvoke.BCrypt.dll",
